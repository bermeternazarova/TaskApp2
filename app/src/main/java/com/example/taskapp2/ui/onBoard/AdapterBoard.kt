...
class AdapterBoard(fm: FragmentManager,
    ...
    private var listBoarding = arrayOf(
        BoardModel(R.raw.working,"To-do list!","Here you can write down something important or make a schedule for tomorrow:)",false),
        BoardModel(R.raw.idea,"Share your crazy idea ^_^","You can easily share with your report, list or schedule and it's convenient",false),
        BoardModel(R.raw.enjoy,"Flexibility","Your note with you at home, at work, even at the resort",true)
    )
